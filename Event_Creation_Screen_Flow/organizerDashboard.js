...
// View states — 'list' is the existing dashboard; 'createEvent' hosts the
// native Event_Creation_Screen_Flow (see event-creation-flow.md), which
// embeds the custom ticketTypeCollector Screen Flow component for the
// dynamic ticket-type step — see ticketTypeCollector.js/.html.
const VIEW = {
    LIST: 'list',
